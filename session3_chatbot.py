# ================================================================
#  🤖  ZARA  -  Your AI Buddy
#  Session 3: Agentic AI — Zara Can Search the Web! 🌐
# ================================================================
#
#  NEW in Session 3:
#  ✅ Zara is now an AGENT — she uses a real search tool!
#  ✅ Tool: Tavily Search API (built specifically for AI agents!)
#  ✅ Groq decides ON ITS OWN when to search
#  ✅ Students see Zara's "thinking" live!
#
#  Why Tavily?
#  - Free API key (2500 searches/month)
#  - Built specifically for AI agents — always reliable!
#  - Never rate limits like DuckDuckGo
#  - Returns clean, relevant results every time
#
#  SETUP:
#    pip install streamlit groq python-dotenv tavily-python
#
#  GET FREE TAVILY KEY:
...
#
#  RUN:
#   streamlit run session3_chatbot.py
# ================================================================
...
# ================================================================
#  🌐  THE TOOL — Tavily Web Search
#
#  Tavily is a search API built specifically for AI agents.
#  It connects to the real internet and always returns results!
#  Free at: https://app.tavily.com
# ================================================================

def search_web(query):
    """Searches the web using Tavily and returns rich results with sources."""
    try:
        ...
        # Collect sources separately so we can display them nicely
        sources = []
        content_for_groq = ""
...
#  🧠  THE AGENT BRAIN
#
#  Step 1: Ask Groq "Should you search or just answer?"
#          Groq replies: YES or NO
#
#  Step 2: If YES → search with Tavily → send results to Groq
#          If NO  → Groq answers directly from knowledge
#
#  Agent = Think → Act → Answer!
# ================================================================

def run_agent(question):
    """
    The agentic loop — Think → Act → Answer
    Returns: (final_reply, did_search, search_query, search_results)
    """
...
st.info(
    "👋 Hi! I'm **Zara** and I just became an **AI Agent!** 🦸‍♀️\n\n"
