# ================================================================
#  🤖  ZARA  -  Your AI Buddy
#  Session 2: Prompt Engineering + Personality + Multi-Model
# ================================================================
#
#  What we learn in Session 2:
#  ✅ Writing a System Prompt (bot personality)
#  ✅ Prompt Engineering — the 5 magic ingredients
#  ✅ Switching between AI models live
#  ✅ Controlling creativity with Temperature
#
#  UPGRADES from Session 1:
#  🆕 SYSTEM_PROMPT  → gives Zara a real personality
#  🆕 MODELS list    → students can swap AI brains
#  🆕 Temperature    → creativity slider in sidebar
#
#  SETUP:  pip install streamlit groq python-dotenv
#  RUN:    streamlit run session2_chatbot.py
# ================================================================

# git add .
# git commit -m "Zara chatbot session 2"
# git push
...
MODELS = {
    ...
    "🎛️ Mixtral 8x7B   (Long Context)":    "mixtral-8x7b-32768",
}
...
with st.sidebar:
    ...
    if temperature <= 0.3:
        ...
        st.caption("✅ Balanced mode (recommended)")
                    ...
                    messages    = [
                        {
                            ...
                            "content": SYSTEM_PROMPT    # Zara's personality
                        },
                        {
                            "role":    "user",
