# ================================================================
#  🤖  ZARA  -  Your AI Buddy
#  Session 4: Memory + File Upload 🧠📄
# ================================================================
#
#  What's NEW in Session 4:
#  ✅ MEMORY — Zara remembers your whole conversation!
#  ✅ FILE UPLOAD — Upload a .txt file, ask Zara about it!
#  ✅ Clear Memory button — fresh start anytime
#
#  SETUP:  pip install streamlit groq python-dotenv
#  RUN:    streamlit run session4_chatbot.py
# ================================================================
...
- You now REMEMBER the whole conversation — use it to give smarter answers!
"""
...
if user_input:
    ...
    # 3️⃣ Build system prompt — attach file content if uploaded
    system_prompt = SYSTEM_PROMPT
    if st.session_state["file_text"]:
        system_prompt += f"\n\nThe student uploaded a file. Here is its content:\n{st.session_state['file_text'][:3000]}"

    # 4️⃣ Get AI reply — send FULL memory to Groq!
    ...
    # 5️⃣ Save Zara's reply to memory too!
