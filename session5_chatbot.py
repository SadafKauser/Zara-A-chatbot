# ================================================================
#  🤖  ZARA  -  Your AI Buddy
#  Session 5: THE FINAL BOT — All Features Combined! 🚀
# ================================================================
#
#  Everything Zara can do now:
#  ✅ Session 1 — Talks to a real AI using Groq
#  ✅ Session 2 — Has a real personality (System Prompt)
#  ✅ Session 3 — Searches the web using Tavily
#  ✅ Session 4 — Remembers your whole conversation
#  ✅ Session 5 — File upload + model switcher + ALL combined!
#
#  SETUP:
#    pip install streamlit groq python-dotenv tavily-python
#
#  RUN:
#    python -m streamlit run session5_chatbot.py
# ================================================================
...
if user_input:
    ...
    # 3️⃣ Build system prompt — add file content if uploaded
    system_prompt = BASE_SYSTEM_PROMPT
    if st.session_state["file_text"]:
        system_prompt += f"\n\nThe student uploaded a file. Here is its content:\n{st.session_state['file_text'][:3000]}"

    # 4️⃣ Run the agent (or skip search if toggled off)
    with st.chat_message("assistant"):
        with st.spinner("🧠 Zara is thinking..."):
            try:
                ...
                # 5️⃣ Show thinking expander (Session 3!)
                if show_thinking:
                    if did_search:
    ...
    # 6️⃣ Save Zara's reply to memory too!
